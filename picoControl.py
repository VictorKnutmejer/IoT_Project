...
SEND_DATA_INTERVAL = 20000    # milliseconds
...
AIO_PORT = 1883
AIO_USER = "Knutmaster"
AIO_KEY = "aio_CEal61ZSi3M7xpCxPZ9kZoeh8att"
...
def send_humidity_AND_temperature_value(): #SENDS THE HUMIDITY SENSOR DATA TO THE HUMIDITY FEED
    ...
    if ((time.ticks_ms() - last_random_sent_ticks) < SEND_DATA_INTERVAL):
    ...
    try:
        client.publish(topic=AIO_HUMIDITY_FEED, msg=str(dhtSensor.humidity))
        print("")
        print("humidity OK")
